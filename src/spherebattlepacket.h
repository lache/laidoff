...
typedef struct _LWSPHEREBATTLEPACKETCREATEBATTLE {
	unsigned short size;
	unsigned short type;
} LWSPHEREBATTLEPACKETCREATEBATTLE;

typedef struct _LWSPHEREBATTLEPACKETCREATEBATTLEOK {
	unsigned short size;
	unsigned short type;
	int battle_id;
} LWSPHEREBATTLEPACKETCREATEBATTLEOK;
